...
# define the usage statement variable that will be read if not all the options are met
  my $usage = "\n$0 -i input_key_file -o output_file -h help\n";
...
for my $group (keys %codons)
  { my $join = join '/', @{ $codons{$group} };
    ...
    my $CTAs1 = () = ($genotype1 =~ /CTA/g);
    my $TTAs1 = () = ($genotype1 =~ /TTA/g);
    my $TCAs1 = () = ($genotype1 =~ /TCA/g);
    
    my $CTAs2 = () = ($genotype2 =~ /CTA/g);
    my $TTAs2 = () = ($genotype2 =~ /TTA/g);
    my $TCAs2 = () = ($genotype2 =~ /TCA/g);
    
    my $CTAs3 = () = ($genotype3 =~ /CTA/g);
    my $TTAs3 = () = ($genotype3 =~ /TTA/g);
    my $TCAs3 = () = ($genotype3 =~ /TCA/g);

    my $CTAs4 = () = ($genotype4 =~ /CTA/g);
    my $TTAs4 = () = ($genotype4 =~ /TTA/g);
    my $TCAs4 = () = ($genotype4 =~ /TCA/g);

    my $geno1stops = $CTAs1 + $TTAs1 + $TCAs1;
    my $geno2stops = $CTAs2 + $TTAs2 + $TCAs2;
    my $geno3stops = $CTAs3 + $TTAs3 + $TCAs3;
    my $geno4stops = $CTAs4 + $TTAs4 + $TCAs4;
